    ...
    <div class="nav__wrapper">
        ...
        <div class="nav__links__wrapper nav__links--right">
            <ul class="nav__links">
                ...
                <li class="nav__links__item md-mr-3 {{ set_active('areas') }}"><a href="{{ route('areas') }}">{{ __('Areas') }}</a></li>
{{--                <li class="nav__links__item {{ set_active('*/categories') }}"><a href="{{ route('category.index', [$area]) }}">{{ __('Listings') }}</a></li>--}}

                @guest
                    <li class="nav__links__item md-mr-3  {{ set_active('login') }}"><a href="{{ route('login') }}">{{ __('Login') }}</a></li>
                    <li class="nav__links__item md-mr-3  {{ set_active('register') }}"><a href="{{ route('register') }}">{{ __('Register') }}</a></li>
