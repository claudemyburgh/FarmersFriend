    ...
    <div class="wrapper">
        <div class="row flex justify--center flex--center">
            <div class="md-col-6 mb-7">
                <h1 class="sponsors__title flex mx-5 flex--row justify--center flex--center">SPONSORS</h1>
            </div>
        </div>
        ...
        <div class="row flex justify--center flex--center">
            <div class="md-col-6 mt-7">
                <h3 class="sponsors__title flex mx-5 flex--row justify--center flex--center"><a href="#">BECOME A SPONSORS</a></h3>
            </div>
        </div>
    </div>
</div>
