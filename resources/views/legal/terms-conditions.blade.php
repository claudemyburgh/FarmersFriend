    ...
    <div class="wrapper">
        <div class="row">
            <div class="md-col-8 md-offset-2">
                ...
                <p>1.1  These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and __________, located at __________, __________, __________ __________ (we, us), concerning your access to and use of the __________ (__________) website as well as any related applications (the Site).</p>

                <p>The Site provides the following services: __________ (Services). You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.</p>
                ...
                <p>1.5  Our site is directed to people residing in __________. The information provided on the Site is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country.</p>
                ...
                <p>2.1  Our full Acceptable Use Policy __________, sets out all the permitted uses and prohibited uses of this site.</p>
                ...
                <p>Falsely imply a relationship with us or another company with whom you do not have a relationship</p>
                ...
                <p>If you know or suspect that anyone other than you knows your user information (such as an identification code or user name) and/or password you must promptly notify us at __________.</p>
                ...
                <p>4.3  In posting User Content, including reviews or making contact with other users of the Site you shall comply with our Acceptable Use Policy __________.
                </p>
                ...
                <p>4.7  If you wish to complain about User Content uploaded by other users please contact us at __________ or use the take down or report button.</p>
                ...
                <h2>6. Link to third party content</h2>
                ...
                <p>Whether you are a consumer or a business user:
                </p>
                <ul>
                ...
                <ol type="a">
                    <li>The licence granted to you for our mobile application is limited to a non-transferable licence to use the application on a device that utilizes the Apple iOS or Android operating system, as applicable, and in accordance with the usage rules set forth in the applicable App Distributor terms of service;</li>
                    ...
                    <li>You must comply with applicable third party terms of agreement when using the mobile application, e.g., if you have a VoIP application, then you must not be in breach of their wireless data service agreement when using the mobile application; and</li>
                    <li>You acknowledge and agree that the App Distributors are third party beneficiaries of these Terms and Conditions, and that each App Distributor will have the right (and will be deemed to have accepted the right) to enforce these Terms and Conditions against you as a third party beneficiary thereof.</li>
                </ol>
                ...
                <p>12.3  Our failure to exercise or enforce any right or provision of these Terms and Conditions shall not operate as a waiver of such right or provision.
                </p>
                <p>12.4  We may assign any or all of our rights and obligations to others at any time.</p>
                <p>12.5  We shall not be responsible or liable for any loss, damage, delay or failure to act caused by any cause beyond our reasonable control.
                </p>
                ...
                <p>12.8  The following are trade marks of __________. You are not permitted to use them without our approval, unless they are part of material our Site explicitly states you are permitted to use.</p>
                ...
                <p>12.10  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at __________ or by post to:</p>
                <p>
                    __________
                    __________
